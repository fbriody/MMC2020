...
1. **Super Easy Method** 
All graphs from this presentation are available for download at https://github.com/fbriody/MMC2020/tree/master/EDA_present_files/figure-html.
...
ACTvLI <- sixco %>% 
  ...
  labs(title = "Low Income Students and ACT Score", x = "School Low Income (%)", y = "School ACT Composite" ) + theme_minimal()
ACTvLI
```
...
**Example: Predicting ACT Scores from Attendance**
