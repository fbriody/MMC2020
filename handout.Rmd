...
Predicting ACT from attendance for all schools: 
```{r}
...
in the ```ggplot``` command. Is there a ***significant*** change? 
...
## Random Selection
The sample command can be used to generate a random  selection. Adding a statistic command and repeating quickly generates a sampling distribution. 
```{r}
